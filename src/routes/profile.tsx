...
function ProfilePage() {
    ...
    const stats = useQuery(
        api.stats.getStats,
        guestId || isAuthenticated ? { odI: isAuthenticated ? undefined : guestId } : 'skip'
    )
        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
            ...
            <main className="max-w-2xl mx-auto p-6">
                ...
                <div className="text-center mb-8">
                    <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-violet-500 to-pink-500 rounded-full flex items-center justify-center">
                        {currentUser?.image ? (
                            <img
                    ...
                    {!isAuthenticated && (
                        <p className="text-sm text-gray-500 mt-2">
                            Mode invité • <Link to="/login" className="text-violet-400 hover:underline">Se connecter</Link> pour sauvegarder
                        </p>
                    )}
                </div>
                ...
                {!stats ? (
                    <div className="text-center text-gray-400 py-12">
                        ...
                        <p className="text-sm mt-2">Jouez quelques parties pour voir vos stats !</p>
                    </div>
                ) : (
                    <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="bg-slate-700/50 rounded-xl p-4">
                                    ...
                                    <div className="flex items-baseline gap-2">
                                        <span className="text-3xl font-bold text-white">{stats.dailyWinStreak}</span>
                                ...
                                <div className="bg-slate-700/50 rounded-xl p-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className="text-sm text-gray-400">Suite du Jour</span>
                                    </div>
                                    <div className="flex items-baseline gap-2">
                                        <span className="text-3xl font-bold text-white">{stats.suiteWinStreak}</span>
                                        <span className="text-sm text-gray-500">actuelle</span>
                                    </div>
                                    <div className="text-xs text-gray-500 mt-1">
                        ...
                        <section className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6">
                            ...
                            <div className="bg-gradient-to-r from-violet-500/20 to-pink-500/20 border border-violet-500/30 rounded-xl p-4 mb-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="text-2xl font-bold text-green-400">{stats.totalWordsFound}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                <div className="bg-slate-700/50 rounded-xl p-3 text-center">
                                    ...
                                    <div className="text-xl font-bold text-white">{stats.dailyGamesPlayed}</div>
                                ...
                                <div className="bg-slate-700/50 rounded-xl p-3 text-center">
                                    ...
                                    <div className="text-xl font-bold text-white">{stats.suiteGamesPlayed}</div>
                                ...
                                <div className="bg-slate-700/50 rounded-xl p-3 text-center">
                                    ...
                                    <div className="text-xl font-bold text-white">{stats.freeGamesPlayed}</div>
                        ...
                        {/* Achievement teaser */}
                        <section className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-6 text-center">
